...
CREATE TABLE PENGUNJUNG (
    ...
    FOREIGN KEY (username_p) REFERENCES PENGGUNA(username) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE DOKTER_HEWAN(
    username_DH VARCHAR(50) PRIMARY KEY,
    no_STR VARCHAR(50) NOT NULL,
    FOREIGN KEY (username_DH) REFERENCES PENGGUNA(username) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE SPESIALISASI(
    ...
    FOREIGN KEY (username_SH) REFERENCES DOKTER_HEWAN(username_DH) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE PENJAGA_HEWAN(
    username_jh VARCHAR(50) PRIMARY KEY,
    id_staf UUID NOT NULL DEFAULT uuid_generate_v4()
    FOREIGN KEY (username_jh) REFERENCES PENGGUNA(username) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE PELATIH_HEWAN(
    username_lh VARCHAR(50) PRIMARY KEY,
    id_staf UUID NOT NULL DEFAULT uuid_generate_v4()
    FOREIGN KEY (username_lh) REFERENCES PENGGUNA(username) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE STAF_ADMIN(
    username_sa VARCHAR(50) PRIMARY KEY,
    id_staf UUID NOT NULL DEFAULT uuid_generate_v4()
    FOREIGN KEY (username_sa) REFERENCES PENGGUNA(username) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE HEWAN (
    ...
    FOREIGN KEY (nama_habitat) REFERENCES HABITAT(nama) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE CATATAN_MEDIS(
    ...
    FOREIGN KEY (username_dh) REFERENCES DOKTER_HEWAN(username_DH) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE MEMBERI(
    ...
    PRIMARY KEY (id_hewan,username_jh,tanggal),
    FOREIGN KEY (id_hewan) REFERENCES HEWAN(id) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (username_jh) REFERENCES PENJAGA_HEWAN(username_jh) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE ATRAKSI(
    ...
    FOREIGN KEY (nama_atraksi) REFERENCES FASILITAS(nama) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE JADWAL_PENUGASAN(
    ...
    PRIMARY KEY (username_lh,tanggal_penugasan),
    FOREIGN KEY (username_lh) REFERENCES PELATIH_HEWAN(username_lh) ON DELETE CASCADE ON UPDATE CASCADE,
);
...
CREATE TABLE BERPARTISIPASI(
    ...
    FOREIGN KEY (nama_fasilitas) REFERENCES FASILITAS(nama) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (id_hewan) REFERENCES HEWAN(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE ADOPTER(
    ...
    FOREIGN KEY (username_adopter) REFERENCES PENGUNJUNG(username_p) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE INDIVIDU(
    ...
    FOREIGN KEY (id_adopter) REFERENCES ADOPTER(id_adopter) ON DELETE CASCADE ON UPDATE CASCADE
);
